export const sensitivitiesIcons: Icon[] =[{ iconMeaning: "spicy", iconUrl: "assets/icons/spicy-icon.svg" },
{ iconMeaning: "vegan", iconUrl: "assets/icons/vegan-icon.svg" },
{ iconMeaning: "vegetarian", iconUrl: "assets/icons/vegetarian-icon.svg" }
]

export const stores:Icon[] = [{ iconMeaning: "App Store", iconUrl: "assets/icons/appleIcon.svg" },
